...
CREATE TABLE public.moon (
    ...
    name_moon character varying(30) NOT NULL,
    edad_moon integer,
...
CREATE TABLE public.planet (
    planet_id integer NOT NULL,
    name_planet character varying(30) NOT NULL,
...
CREATE TABLE public.star (
    star_id integer NOT NULL,
    name_star character varying(30) NOT NULL,
    edad_star integer,
...
COPY public.galaxy (galaxy_id, name, description) FROM stdin;
1	ANDRÓMEDA	\N
2	VIA LÁCTEA	\N
3	TRIÁNGULO	\N
4	MAGALLANES	\N
...
COPY public.moon (moon_id, name_moon, edad_moon, distancia_moon, planet_id) FROM stdin;
...
COPY public.planet (planet_id, name_planet, edad_planeta, distancia_planeta, radius, star_id) FROM stdin;
...
COPY public.star (star_id, name_star, edad_star, distancia_tierra, has_life, es_esferica, galaxy_id) FROM stdin;
